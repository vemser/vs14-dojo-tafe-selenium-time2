...
public class HomePage extends Interactions {
    ...
    public static final By seta = By.cssSelector("#app > div.oxd-layout.orangehrm-upgrade-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > form > div:nth-child(1) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.oxd-select-text--after > i");
    ...
    public static final By textValidCampoEmployeeNulo = By.cssSelector("#app > div.oxd-layout.orangehrm-upgrade-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > form > div:nth-child(1) > div > div:nth-child(2) > div > span");
...
//    }
    ...
    public String validEmpolyText(){
        return  lerTexto(textValidCampoEmployeeNulo);
    }
}
